...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/6289690719275 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------alpinofc'+'alpinofc';
...
router.get('/maker3d', async (req, res, next) => {
    ...
    if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://alpin-apikey.herokuapp.com/api/text3d?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no2', async (req, res, next) => {
	...
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
    if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://alpin-apikey.herokuapp.com/api/text3d-2?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no3', async (req, res, next) => {
	...
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
    if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://alpin-apikey.herokuapp.com/api/text3d-3?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3d/no4?', async (req, res, next) => {
	...
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
    if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://alpin-apikey.herokuapp.com/api/text3d-4?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker', async (req, res, next) => {
	...
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
    if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://alpin-apikey.herokuapp.com/api/textmaker?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker2', async (req, res, next) => {
	...
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
    if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://alpin-apikey.herokuapp.com/api/textmaker2?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/lk21', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
    if(!query) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
...
router.get('/lk21/terbaru', async (req, res, next) => {
	...
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api-lk21.herokuapp.com/newupload?page=`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker3', async (req, res, next) => {
	...
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
    if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://alpin-apikey.herokuapp.com/api/textmaker3?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/maker4', async (req, res, next) => {
	...
	if(apikeyInput != 'alpinofc') return res.json(loghandler.invalidKey)
    if(!kata) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter kata"})
       fetch(encodeURI(`https://alpin-apikey.herokuapp.com/api/textmaker4?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
